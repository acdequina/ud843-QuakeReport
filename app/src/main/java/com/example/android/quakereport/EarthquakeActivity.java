...
public class EarthquakeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<EarthquakeData>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEarthquakeListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                EarthquakeData data = mAdapter.getItem(i);
    ...
    @Override
    public void onLoadFinished(Loader<List<EarthquakeData>> loader, List<EarthquakeData> earthquakeDataList) {
        mAdapter.clear();
        if(earthquakeDataList != null && !earthquakeDataList.isEmpty()) {
            mAdapter.addAll(earthquakeDataList);
        }
